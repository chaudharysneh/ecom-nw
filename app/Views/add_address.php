                ...
                <form id ="address_form_data">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="firstname" name="firstname" type="text" class="form-control" maxlength="20" value="<?php //echo $profile_data['UserFirstName']; ?>">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="lastname" name="lastname"  type="text" class="form-control" maxlength="20" value="<?php //echo $profile_data['UserLastName']; ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                      ...
                      <button type="button" id="add_address_form" class="btn btn-block rounded  mt-3"><i class="fa fa-save"></i> Save changes</button>
