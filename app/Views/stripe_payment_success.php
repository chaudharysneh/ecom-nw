...
?>
   ...
   <div class="container mt-4 mb-5">
         ...
         <div style="width:100%;text-align:center">
                  <img src="https://ecomweb.fableadtechnolabs.com/admin/public/upload_images/1728803054_e8778ea13ec894e43181.png" alt="Pharmaxy logo"/>
...
<tr style="border: none;">
    ...
    <h3 class="hdr mt-5 mb-2">Your product detail :</h3>
     <div class="align-items-end d-flex justify-content-end">
                <a class="btn btn-primary customer-order-btn rounded m-0 mt-4 link-text" style="font-size:15px;" href="<?php echo base_url('invoice/' . $ord->OrderID); ?>" target="_blank">
        ...
        <tbody>
            <?php if (!empty($orditm)): ?>
                <?php foreach ($orditm as $orddt): ?>
                    ...
                    ?>
                    <tr>
                        <td><img class="img-fluid" height="50" width="50" src="<?= base_url('admin/public/assets/img/product_images/'.$singleimg); ?>"></td>
...
?>
    ...
    <a href="<?php echo base_url(); ?>" class="btn rounded link-text text-capitalize" style="font-weight:500;font-size:16px;">
        <i class="fa fa-chevron-left"></i> Continue shopping
                ...
                <div class="mt-4" style="width:100%;padding:1px;border-radius:5px;text-align:center">
                    <h6 class="text-capitalize" style="text-align:center;color:#000;">
                        If you have any issues with the order kindly contact <a class="btn rounded px-3 py-2" href="tel:<?=$all_setting_data['Phone'] ?? '';?>" style="color:#fff;text-decoration:none;font-size: 15px;font-weight:500;"><i class="fa-solid fa-phone mr-1"></i>Call Us</a>
                    </h6>
                </div>
