          ...
          <div class="card sidebar-menu mb-4 d-none d-lg-block" style="box-shadow:none !important;">
            ...
            <div class="card-body" style="height:100px;">
              <div class="range-slider2">
                <span class="rangeValues2 text-center"></span>
          ...
          <div class="text-inner">
             ...
             <div class="box info-bar py-0 py-lg-2 mt-0 mt-lg-4 mb-0 mb-sm-1">
                ...
                <div class="col-md-6 col-lg-6 col-6 products-showing">
                  <p class="mt-0">Sub Category:<strong style="font-size:15px;">
                      <?php
                      // print_r($id);
                      echo $catname->sub_category;
                      ?>
                    </strong></p>
                      ...
                      <div class="bbb_deals">
                              ...
                              <div class="bbb_deals_content">
                                <div class="bbb_deals_info_line d-flex flex-column justify-content-start">
                                  ...
                                  <p style="font-size:13px;font-weight:500;">
                                      <?php
                                      helper('text');
                                      echo word_limiter($resdt['ProductName'], 5);
                                      ?>
                                    </p>
                                  </div>
                                  <?php
                                  ...
                                  <?php
                                    ...
                                    // $varprod = $variations->where('ProductID',$resdt['ProductID'])->get()->getResult('array');
                                    foreach ($varprod as $vardt) {
                                      $pricearr[] = $vardt['VariationPrice'];
                                    }
                                    ?>
                                    <div class="bbb_deals_item_price ml-auto"><?php echo $all_setting_data['currency']; ?><?php echo array_sum($pricearr); ?></div>
                        ...
                        <div class="button d-flex text-start">
                            <form class="addtocartform" action="/addToCart" method="POST">
                              ...
                              <button class="btn cart_btn add_cart link-text mt-0 rounded" type="submit">Add to Cart</button>
                            </form>
                          </div>
                          </div>
                          <!-- <div class="col-lg-6 align-self-center text-right"> -->
                          <div class="col-lg-2 col-md-2 col-6 align-self-center text-right px-0 ct-heart">
