...
<div class="text-nowrap m-5">
   <div class="card">
      <div class="card-body p-2">
         <span class="addprobtn2">Create Discounts & Coupons</span>
      </div>
   </div>
               ...
               <div class="col-md-12 tag-mar">
                  <div class="card mb-4">
                     ...
                     <div class="card-body">
                        ...
                        <textarea type="text" class="form-control coupon-description" id="defaultFormControlInput" aria-describedby="defaultFormControlHelp"></textarea>
                      </div>
                                      </div>
                              ...
                              <div class="col-lg-6">
                                  ...
                                  <div class="row">
                                       ...
                                       <select id="largeSelect" class="form-select ">
                                          <option>Select Discount On</option>
                           ...
                           <div class="col-lg-12 text-right">
                              <button class="addprobtn" type="submit">Create Coupon</button>
                           </div>
                        </div>
