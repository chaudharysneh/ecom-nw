...
<div class="table-responsive text-nowrap m-5">
	...
	<div class="card-body p-2">
		<span class="addprobtn2">CMS Pages</span><a href="add_cms_page.php"><span class="addprobtn">Add CMS Page</span></a>
	</div>
</div>
	<div class="card mt-3">
		<div class='card-body'>
      ...
      <thead>
        <tr>
          ...
          <th style="width: 58%;">Desciption</th>
          <th>Actions</th>
        </tr>
      </thead>
          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu" style="">
                  <a class="dropdown-item" href="view_cms_page.php"><i class="fa fa-eye" aria-hidden="true"></i> View </a>
