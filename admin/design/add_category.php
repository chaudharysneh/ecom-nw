          ...
          <div class="text-nowrap m-5">
            <div class="card">
              <div class="card-body p-2">
          		<span class="addprobtn2">Add Category</span><a href="all_category.php"><span class="addprobtn">All Category</span></a>
              </div>
             </div>
             <form>
                ...
                <div class="col-md-6 tag-mar">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <a href="category.php"><span class="addprobtn">Add Category</span></a>
                      </div>
                    </div>
                  </div>
                </div>
