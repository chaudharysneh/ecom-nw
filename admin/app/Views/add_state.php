          ...
          <div class="text-nowrap m-5">
            <div class="card">
              <div class="card-body p-0">
          		<span class="addprobtn2">Add State</span><a href="<?php echo base_url(); ?>all_state"><span class="addprobtn">State</span></a>
              </div>
             </div>
             <form id="add_state">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="con_name" name="con_name" class="form-select con_name">
                           ...
                           <?php 
                              foreach($allcountryydata as $country){                                                
                                ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="state_name" name="state_name"  aria-describedby="defaultFormControlHelp">
                      <p class="text-danger state_name_err"> </p>
                     </div>
                      <p id="msg"> </p>
                      <div class="card-body p-2 mb-3">
                      <button type="button" class="addprobtn" id="add_state_data">
                      Add State</button>
...
<script>
     $('#add_state_data').on('click', function () {
          // alert ("hi");
          ...
          if (flag == 1) {
              ...
              let myform = document.getElementById('add_state');
