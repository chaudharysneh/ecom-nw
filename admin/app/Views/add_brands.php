<!--text/x-generic add_tag.php ( ASCII HTML document text, with CRLF line terminators )-->
<style>
  .textarea {
    width: 100%;
    font-size: 0.9375rem;
...
<div class="text-nowrap m-3 mx-lg-4">
  <div class="card">
    <div class="card-body p-0">
      <span class="addprobtn2">Add Brand</span><a href="<?php echo base_url(); ?>all-brands"><span class="addprobtn">Brands</span></a>
    </div>
  </div>
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="card-body p-2 mb-3">
                  <button type="button" class="addprobtn" id="add_brands_data">
                    Add Brand</button>
