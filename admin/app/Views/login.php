            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">ECOM</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to ECOM! 👋</h4>
              <p class="mb-4">Please sign-in & Manage admin panel.</p>
              ...
              <form id="formAuthentication" class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" id="login" type="button">Sign in</button>
                </div>
              </form>
