...
<div class="text-nowrap m-5">
   <div class="card">
      <div class="card-body p-0">
         <span class="addprobtn2">CMS Page</span><a href="<?php echo base_url(); ?>all_cms"><span class="addprobtn">All CMS</span></a>
      </div>
   </div>
   <form method="post" enctype="multipart/form-data" id="add_cms_form_data">
               ...
               <div class="col-md-12 tag-mar">
                  <div class="card mb-4">
                     ...
                     <div class="card-body">
                        ...
                        <div class="mb-3">
                           <div>
                              <textarea id="description" name="description" class="description" aria-describedby="inputGroupPrepend5"></textarea>
                           </div>
                        ...
                        <div class="col-md-12">
                           ...
                           <input type="checkbox" id="faqs" name="faqs" value="Faq">


                        </div>

                        <div class="faq_data wrapper">
                        ...
                        <div class="card-body p-2 mb-3">
                           ...
                           <!-- <span class="addprobtn mb-3" id="add_cms_btn">Add CMS Page</span> -->
                           <span class="addprobtn mb-3 mt-3" id="cms_submit_data">Add CMS Page</span>
...
<script>
   ...
   //     var content = editor.getData(); // Get the editor's HTML content
   //     var cleanedContent = removeInlineStyles(content); // Remove inline styles
   //     editor.setData(cleanedContent); // Set the cleaned content back to the editor
   //   });
   ...
   //         var cleanedContent = removeInlineStyles(htmlContent);
...
<script>
   $(document).ready(function() {
      ...
      $('#cms_submit_data').on('click', function() {



         var htmlContent = CKEDITOR.instances.description.getData();
         ...
         if ($('#faqs').prop('checked')) {
            ...
            $("textarea[name='faq_answer[]']").each(function(i) {
               ...
               if ($(this).val() == '') {
                  $(this).next('#answer_errors' + i).show();
                  $(this).next('#answer_errors' + i).html('Please enter answer!').addClass("text-danger");
                  flag = 0;
               } else {
                  $(this).next('span').hide()
               }
         ...
         if (flag == 1) {
            var add_cms_form_data = document.getElementById("add_cms_form_data");
            var fd = new FormData(add_cms_form_data);
            fd.append('htmlContent', htmlContent);
            fd.append('ischecked', check);
            $.ajax({
               url: '<?php echo base_url("cms/create"); ?>',
               type: 'POST',
               data: fd,
               cache: false,
               contentType: false,
               ...
               success: function(response) {
                  ...
                  Swal.fire({
                     icon: 'success',
                     title: 'Success',
                     text: 'CMS Data Added Successfully!',
                     timer: 2000, // Alert will close after 2 seconds
                     showConfirmButton: false
                  }).then(function() {
                     // Redirect to 'all_cms' after the alert closes
