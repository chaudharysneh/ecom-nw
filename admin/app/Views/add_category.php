...
<div class="text-nowrap m-3 mx-lg-4">
  <div class="card">
    <div class="card-body p-0">
      <span class="addprobtn2">Add Category</span><a href="<?php echo base_url(); ?>all-categories"><span class="addprobtn">All Category</span></a>
    </div>
  </div>
  <form id="add_catagories" enctype="multipart/form-data">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" type="file" id="filetoupload" name="catagory_image">
                  <p class="text-danger file_err m-0"> </p>
                </div>
                <div class="card-body p-2 mb-3">
                  <button type="button" class="addprobtn" id="add_catagories_data">
                    Add Category</button>
                </div>
                <p id="msg"> </p>
              </div>
