...
<div class="text-nowrap m-3 mx-lg-4">
  <div class="card">
    <div class="card-body p-0">
      <span class="addprobtn2">Add Tag</span><a href="<?php echo base_url(); ?>all-tags"><span class="addprobtn">Tags</span></a>
    </div>
  </div>
  <form id="add_tags">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="card-body p-2 mb-3">
                  <button type="button" class="addprobtn" id="add_tags_data">
                    Add Tags</button>
