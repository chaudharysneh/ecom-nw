...
<?= $this->include ('templates/header') ?>
          ...
          <div class="text-nowrap m-5">
            <div class="card">
              <div class="card-body p-0">
          		<span class="addprobtn2">Edit Shipping method</span><a href="<?php echo base_url(); ?>all_methods"><span class="addprobtn">All Shipping methods</span></a>
              </div>
             </div>
          ...
          <div class="content-wrapper">
            ...
            <div class="flex-grow-1 container-p-y">
              ...
              <input type="hidden" id="base_url" value="<?php echo base_url('all_methods') ?>">
               <input type="hidden" name="shipping_id" id="shipping_id" value="<?php echo $single_shipping_data['MethodID'];?>">
...
<script>
     $('#edit_shipping_data').on('click', function () {
          ...
          if (flag == 1) {
             ...
             fd.append('methods',true);
         
            $.ajax({
              url: 'update_shipping_methods',
              data: fd,
              cache: false,
              processData: false,
              contentType: false,
