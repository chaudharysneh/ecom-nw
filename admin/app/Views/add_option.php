...
<div class="text-nowrap m-3 mx-lg-4">
  <div class="card">
    <div class="card-body p-0">
      <span class="addprobtn2">Add Options</span><a href="<?php echo base_url(); ?>all-options"><span class="addprobtn">Options</span></a>
    </div>
  </div>
  <form id="add_options">
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="card-body p-2 mb-3">
                  <button type="button" class="addprobtn" id="add_options_data">
                    Add Options</button>
