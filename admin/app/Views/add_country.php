                ...
                <div class="col-md-6 tag-mar">
                  <div class="card mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="con_name" name="con_name"  aria-describedby="defaultFormControlHelp">
                      <p class="text-danger con_name_err"> </p>
                      </div>
                      <p id="msg"> </p>
                      <div class="card-body p-2 mb-3">
                      <button type="button" class="addprobtn" id="add_country_data">
                      Add Country</button>
...
<script>
     $('#add_country_data').on('click', function () {
          // alert ("hi");
          ...
          if (flag == 1) {
              ...
              let myform = document.getElementById('add_country');
