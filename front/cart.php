			...
			<div class="row">
				<div class="col-md-9 col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<tr>
								<td class="image" data-title="No"><img src="images/list/shop-list1.jpg" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Women Dress</a></p>
									<p class="product-des"> Lorem Ipsum Lorem Ipsum</p>
								</td>
							...
							<tr>
								<td class="image" data-title="No"><img src="images/list/shop-list3.jpg" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Women Dress</a></p>
									<p class="product-des">Lorem Ipsum Lorem Ipsum</p>
								</td>
							...
							<tr>
								<td class="image" data-title="No"><img src="images/list/shop-list2.jpg" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Women Dress</a></p>
									<p class="product-des">Lorem Ipsum Lorem Ipsum</p>
								</td>
                    ...
                    <div class="left"><button class="btn"><a href="products.php" class="link-text"><i class="fa fa-chevron-left"></i> Continue shopping</a></button></div>
                    <div class="right">
                      <button class="btn"><a href="#" class="link-text"><i class="fa fa-refresh"></i> Update cart</a></button>
                      <button type="submit" class="btn"><a href="checkout.php" class="link-text">Proceed to checkout <i class="fa fa-chevron-right"></i></a></button>
                    </div>
                  </div>
                </div>  
				</div>
                ...
                <form>
                  <div class="input-group">
                    <input type="text" class="form-control"><span class="input-group-append">
                      <button type="button" class="btn cart-btn"><i class="fa fa-gift"></i></button></span>
                  </div>
                  <!-- /input-group-->
                </form>
              </div>
