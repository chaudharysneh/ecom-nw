              ...
              <div class="card sidebar-menu">
                ...
                <div class="card-body">
                  <ul class="nav nav-pills flex-column">
                      ...
                      <a href="my_account.php" class="nav-link active"><i class="fa fa-user"></i> My account</a>
		...
		<div class="col-lg-9 col-12 mb-5">
			<div class="card account-card">
              <div class="card-body">
                ...
                <p class="">Change your personal details or your password here.</p>
                <p class="text-muted">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
                <h4 class="mb-2 mt-2">Change password</h4>
                <form>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="password_old">Old password</label>
                        <input id="password_old" type="password" class="form-control form-control-lg">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="password_1" type="password" class="form-control form-control-lg">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="password_2">Confirm password</label>
                        <input id="password_2" type="password" class="form-control form-control-lg">
                      </div>
                    </div>
                  </div>
                  <!-- /.row-->
                  <div class="col-md-12 text-center">
                    <button type="submit" class="btn"><i class="fa fa-save"></i> Save new password</button>
                  </div>
                </form>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="company" type="text" class="form-control form-control-lg">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
